...
import com.albaycan.resourceplanner.service.ReportingManagerImp;
...
public class UIControllerFactory {
	...
	private static ReportingManager reportingManager = new ReportingManagerImp(inventoryManager, orderManager);
	...
	private static ReportUIController reportUIController = new ReportUIController(reportingManager);
